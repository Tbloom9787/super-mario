import pygame
from source import game_functions, coin, powerup, settings
...
class Box(pygame.sprite.Sprite):
    ...
    def load_frames(self):
        sheet = settings.GFX['tile_set']
        frame_list = [(384, 0, 16, 16), (400, 0, 16, 16),
                           (416, 0, 16, 16), (400, 0, 16, 16), (432, 0, 16, 16)]

        for frame_rect in frame_list:
            self.frames.append(game_functions.get_image(sheet, *frame_rect, c.BLACK, c.BRICK_SIZE_MULTIPLIER))
