from source import coin, powerup, objects, settings
from source import constants as c


class Brick(objects.Object):
    def __init__(self, x, y, type, color=c.ORANGE, group=None, name=c.MAP_BRICK):
        ...
        objects.Object.__init__(self, x, y, settings.GFX['tile_set'],
...
class BrickPiece(objects.Object):
